...
namespace OX_Race
{
    public partial class OxRaceForm : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[0] = pFactory.getPunter("Avneet", MaximumBet, AvneetBet); //getting Avneet object from factory class
        ...
        private void AvneetButton_CheckedChanged(object sender, EventArgs e)
        {
